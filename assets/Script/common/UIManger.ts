...
export default class UIManger extends cc.Component {
    /**
     * 单例
     */
    ...
    public switchLayer(layer: typeof cc.Component, object: any = {}, remove: boolean = true): void {
        ...
        if (this.currentLayer instanceof CCComponent) {    //若为 CCComponent，则调用initComponent
            (<CCComponent>this.currentLayer).initComponent(object);
        }
        if (remove) {
